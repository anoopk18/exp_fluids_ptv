%Question 3, parts a and b, fluid 2
%import the mat matrix
%based on Eva's reference for allocation array [x position , y position, time (s), trajectory number]

folderPath = 'R:\ENG_Breuer_Shared\group\Eva\experimental_fluids_PTV\fluid2pix\';
fileName = 'trajectories_x_y_time_trajectorynumberfl2.mat';  % Change 'your_data_file.mat' to the actual file name
